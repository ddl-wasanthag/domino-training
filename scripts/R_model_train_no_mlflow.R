...
with(mlflow_start_run(), {
    ...
    save(lm_model, file = "/mnt/models/R_linear_model_no_mlflow.Rda")
    # save(lm_model, file="/mnt/artifacts/models/R_linear_model.Rda")
    # mlflow.log_artifact("/mnt/models/R_linear_model_no_mlflow.Rda")
    # mlflow.log_artifact("/mnt/artifacts/models/R_linear_model.Rda")

    # Plotting actual vs predicted values
    png(filename = "/mnt/visualizations/R_actual_v_pred_hist_no_mlflow.png")
