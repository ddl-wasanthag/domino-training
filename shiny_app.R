...
#### COPY FULL LINES 4-7 from R tab in Model APIS page over this line of code. (It's a simple copy and paste) ####
    url <- "https://prod-field.cs.domino.tech:443/models/66319c70c5e41b5dad959307/latest/model"
response <- POST(
  url,
 authenticate("0A0lq2znJ7XP04ODrYOcaoAptXrQ0kVqrMWUMI3yssR5MC8mhFyCXRvFa1gsnEnC", "0A0lq2znJ7XP04ODrYOcaoAptXrQ0kVqrMWUMI3yssR5MC8mhFyCXRvFa1gsnEnC", type = "basic"),
